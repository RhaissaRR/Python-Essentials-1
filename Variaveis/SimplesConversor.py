...
Não altere nada no código atual. Escreva seu código nos locais indicados por ###. 
...
Observe que alguns dos argumentos dentro da função print() são strings (por exemplo, 
"milhas é", enquanto outros são variáveis (por exemplo, miles)."""
